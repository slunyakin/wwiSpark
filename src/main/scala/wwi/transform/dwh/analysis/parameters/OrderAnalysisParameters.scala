package wwi.transform.dwh.analysis.parameters
...
case class OrderAnalysisParameters(val arguments: Seq[String]) extends BaseParams(arguments) with RequiredParams {
